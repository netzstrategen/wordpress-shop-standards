  ...
  public static function register_acf() {
    ...
    register_field_group([
      ...
      'fields' => [[
        ...
        'label' => __('Recommended Own-Brand Product ID', Plugin::L10N),
        'name' => 'recommended_own_brand_product',
        'type' => 'number',
        'instructions' => __('Enter the product ID of the recommended own-brand product to display as an alternative or complement to this product.', Plugin::L10N),
        'placeholder' => __('e.g. 598274', Plugin::L10N),
        'min' => 1,
        'step' => 1,
      ]],
      'location' => [[[
